  ...
  return (
    <section className="bg-slate-50 py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Added vertical space for hover movement */}
                ...
                <motion.div
                  ...
                  <div className="p-6 text-center">
                    ...
                    <div className="mt-5 flex justify-center gap-3">
                      <button className="flex h-9 w-9 items-center justify-center rounded-full bg-blue-50 text-[#12396d] hover:bg-[#12396d] hover:text-white">
                        <FaLinkedin />
                      </button>

                      <button className="flex h-9 w-9 items-center justify-center rounded-full bg-red-50 text-[#A42F2B] hover:bg-[#A42F2B] hover:text-white">
                        <FaEnvelope />
                      </button>
                    </div>
